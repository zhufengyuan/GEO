...
- 文案显示：标题旁提供“文案显示”按钮弹窗预览，超长内容支持滚动。
- 产品宣传创作/主题活动创作：每次“开启创作”生成 1 篇并写入文章管理。
- 企业品牌创作：每次“开启创作”生成 3 篇同类型不同版本；右侧提供 3 个“文案优化建议”区域分别对应 3 篇内容。
- 重新优化：等同 rewrite，生成改稿版本；企业品牌创作可在 3 个优化区域中选择其中 1 篇点击“确定”写入文章管理，标题前缀为【改稿1】/【改稿2】/【改稿3】。
- 滚动规则：页面不会因优化建议内容变形撑高；长内容只在“文案优化建议”的显示框内滚动。
